...
pylib\python\python.exe pylib\export.py datasrc ..\..\My_Shop\Assets\Resources\Jsons\

pylib\python\python.exe pylib\export.py datasrc ..\AutoChangeJson\gamedb\Jsons\
